...
* This will navigate to Sign Up page, where the User is required to enter the following information: <b>First Name > Last Name > Email > Country > Password </b>

2. Select <b>Sign Up For Free</b> button </b>
...
* Now User is on Dashboard screen. Follow the link <b>API TOKENS, as shown below</b>
